...
public class JacketsPage extends Utility {
    //By productname = By.xpath("//body[1]/div[2]/main[1]/div[3]/div[1]/div[2]/div[3]/select[1]/option[2]");

    //By price = By.xpath("//div[@class='page-wrapper']//div[2]//div[3]//select[1]//option[3]");
